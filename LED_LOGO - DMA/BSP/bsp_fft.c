...
void DMA_WS2812_FFT_DSPALY(uint16_t fft_x,uint16_t fft_y,volatile uint8_t pwm,float *arr)
{
	...
	uint8_t t=0;
     ...
     {
        t++;
        led_x[i]=(arr[i+10]*2/512)*0.05 ;   //一个频率点的幅值
	   if(t%2==0)
		 {
	   one_y_dspaly(i+1, 1,5,led_x[i],8);
     one_y_dspaly(i+2, 1,5,led_x[i],8);
		 one_y_dspaly(i+3 ,4,5,0,8);
		 }
		 else
		 {
		 one_y_dspaly(i+1, 2,5,led_x[i],8);
     one_y_dspaly(i+2, 2,5,led_x[i],8);
		 one_y_dspaly(i+3 ,4,5,0,8);
		 }
...
//	   one_y_dspaly(1, 1,5,led_x[0],8);
//     one_y_dspaly(2, 2,5,led_x[0],8);
//		one_y_dspaly(3, 1,5,led_x[1],8);
//     one_y_dspaly(4, 2,5,led_x[1],8);
//			 one_y_dspaly(5, 1,5,led_x[2],8);
//     one_y_dspaly(6, 2,5,led_x[2],8);
//			 one_y_dspaly(7, 1,5,led_x[3],8);
//     one_y_dspaly(8, 2,5,led_x[3],8);
//			 one_y_dspaly(9, 1,5,led_x[4],8);
//     one_y_dspaly(10, 2,5,led_x[4],8);
//			 one_y_dspaly(11, 1,5,led_x[5],8);
//     one_y_dspaly(12, 2,5,led_x[5],8);
