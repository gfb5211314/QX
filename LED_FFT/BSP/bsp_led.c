...
/**********PWM一个传输************************/
/***采用发送2个LED,48个字节，利用DMA发送一半中断，然后把数据填充到第一个位置，发送完成填充到第二个位置**/

void  led_PWM(volatile uint16_t  amount, colors_kind  color, volatile uint8_t pwm)
{
