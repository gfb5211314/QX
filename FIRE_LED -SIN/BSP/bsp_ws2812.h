...
extern void  app_runing(volatile uint16_t  amount, colors_kind  color, uint8_t pwm,uint8_t flag,uint32_t time);

extern  void  led_run(volatile uint16_t  amount, colors_kind  color, volatile uint8_t pwm);
